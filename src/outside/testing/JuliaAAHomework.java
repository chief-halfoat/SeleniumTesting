...
public class JuliaAAHomework { public static String url = ("https://www.aa.com/homePage.do");
...
//        next.click();//next button
        List<WebElement> deparD = driver.findElements(By.xpath("//*[@id=\"ui-datepicker-div\"]/div[1]/table/tbody/tr/td"));//semana
        for (WebElement deparDs: deparD) {
            if(deparDs.getText().equals("25")){
                deparDs.click();
                break;
            }
